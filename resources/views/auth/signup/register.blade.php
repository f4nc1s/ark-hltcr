...
<body class="bg-white">
    ...
    <div class="mx-0 row authentication authentication-cover-main" x-data="{ step: 1, method: 'phone' }">
                ...
                <div class="col-xxl-7 col-xl-9 col-lg-6 col-md-6 col-sm-8 col-12">
                    <div class="my-5 border card custom-card">
                        <div class="p-5 card-body">
                            ...
                            <!-- Multi-Step Form -->
                            <div x-show="step === 1">
                                @include('auth.signup.phone-input')
                            </div>
                            
                            <div x-show="step === 1 && method === 'email'">
                                @include('auth.signup.email-input')
                            </div>

                            <div x-show="step === 2">
                                @include('auth.signup.otp')
                            </div>

                            <div x-show="step === 3">
                                @include('auth.signup.password-wizard')
                            </div>

                            <div x-show="step === 4">
                                @include('auth.signup.successful')
                            </div>
